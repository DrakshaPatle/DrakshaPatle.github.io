...
<div _ngcontent-c1="" className="ui-g-12 ui-lg-12 ">
  ...
  <div _ngcontent-c1="" className="ui-g-12 ui-md-6">
    <p _ngcontent-c1="" className="sub-heading">
    ...
    <div _ngcontent-c1="" className="ui-g-12 ui-md-10 ui-md-offset-1 ui-lg-4 ui-lg-offset-4">
      <div _ngcontent-c1="" className="ui-g-8 ui-g-offset-2 ui-inputgroup">
        <button _ngcontent-c1="" className="ui-button-success add-theme-border add-theme-background-color ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only" icon="fa fa-minus" pbutton="" type="button" ng-reflect-icon="fa fa-minus">
        ...
        <input _ngcontent-c1="" className="add-theme-border ng-pristine ng-valid ui-inputtext ui-corner-all ui-state-default ui-widget ui-state-filled ng-touched" pinputtext="" placeholder="No. of Bedrooms" readonly="" type="text" ng-reflect-model="1"/>
        <button _ngcontent-c1="" className="ui-button-danger add-theme-border add-theme-background-color ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only" icon="fa fa-plus" pbutton="" type="button" ng-reflect-icon="fa fa-plus">
  ...
  <div _ngcontent-c1="" className="ui-g-12 ui-md-6">
    ...
    <div _ngcontent-c1="" className="ui-g-12 ui-md-10 ui-md-offset-1 ui-lg-4 ui-lg-offset-4">
      <div _ngcontent-c1="" className="ui-g-8 ui-g-offset-2 ui-inputgroup">
        ...
        <input _ngcontent-c1="" className="add-theme-border ng-untouched ng-pristine ng-valid ui-inputtext ui-corner-all ui-state-default ui-widget ui-state-filled" pinputtext="" placeholder="No. of Bathrooms" readonly="" type="text" ng-reflect-model="1"/>
        <button _ngcontent-c1="" className="ui-button-danger add-theme-border add-theme-background-color ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only" icon="fa fa-plus" pbutton="" type="button" ng-reflect-icon="fa fa-plus">
          <span aria-hidden="true" className="ui-button-icon-left ui-clickable fa fa-plus">
          </span>
          <span className="ui-button-text ui-clickable">
